...
func (repository *Oauth2RepositoryImpl) FindUserByEmail(ctx context.Context, tx *sql.Tx, email string) (domain.UserModel, error) {
...
func (repository *Oauth2RepositoryImpl) FindUserById(ctx context.Context, tx *sql.Tx, userId int64) (domain.UserModel, error) {
...
func (repository *Oauth2RepositoryImpl) FindClientById(ctx context.Context, tx *sql.Tx, clientId int64) (domain.ClientModel, error) {
...
func (repository *Oauth2RepositoryImpl) FindDataContextByUserId(ctx context.Context, tx *sql.Tx, userId int64) (domain.DataContextModel, error) {
